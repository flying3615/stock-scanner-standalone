...
function MoneyFlowGauge({ value }: { value: number }) {
                ...
                <div className="p-6 border-b border-neutral-800 flex justify-between items-start sticky top-0 bg-neutral-900 z-10">
                    <div>
                        ...
                        {selectedStock.sector && (
                            <div className="mt-2 text-xs font-semibold text-blue-400 bg-blue-400/10 px-2 py-1 rounded inline-block border border-blue-400/20">
                                {selectedStock.sector}
                            </div>
                        )}
                    </div>
